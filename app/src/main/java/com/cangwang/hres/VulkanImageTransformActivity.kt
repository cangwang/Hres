...
class VulkanImageTransformActivity: AppCompatActivity() {

    private val TAG = VulkanImageTransformActivity::class.java.simpleName
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        HresJniUtil.nativeCreateTransformer("VulkanTransformImage", engineOption.toJson(), null)
        HresJniUtil.nativeSetListener(object : HresListener {
            ...
            override fun hresTransformComplete(imageOption: ImageOptionParams) {
                btn_album_transform.post {
                    val desBitmap = BitmapFactory.decodeFile(imageOption.saveAddress)
