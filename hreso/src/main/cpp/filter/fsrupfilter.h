...
#ifndef HRES_FsrUpFilter_H
#define HRES_FsrUpFilter_H
#include <filter/ifilter.h>

#define LOG_TAG "FsrUpFilter"
#define HLOGE(...) __android_log_print(ANDROID_LOG_ERROR, LOG_TAG, __VA_ARGS__)
#define HLOGV(...) __android_log_print(ANDROID_LOG_VERBOSE, LOG_TAG, __VA_ARGS__)

class FsrUpFilter: public IFilter {
public:
    FsrUpFilter(string type);
    ~FsrUpFilter();
