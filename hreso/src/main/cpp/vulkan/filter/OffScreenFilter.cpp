...
int OffScreenFilter::createDescriptorLayout() {
    ...
    binding.push_back(vks::descriptorSetLayoutBinding(VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER, VK_SHADER_STAGE_VERTEX_BIT, 0, 1));
    binding.push_back(vks::descriptorSetLayoutBinding(VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, VK_SHADER_STAGE_FRAGMENT_BIT, 1, 3));
    ...
    return VulkanFilter::createDescriptorLayout();
}
