...
#include "OffScreenImageFilter.h"

int OffScreenImageFilter::init(VkDevice device, VkRenderPass renderPass) {
    if (isInit){
        return VK_SUCCESS;
    }
...
int OffScreenImageFilter::updateDescriptorSet(VkSampler sampler, VkImageView imageView, VkImageLayout imageLayout) {
...
int OffScreenImageFilter::updateDescriptorSet(vector<VkDescriptorBufferInfo> &bufferInfo,
...
int OffScreenImageFilter::createDescriptorLayout() {
...
int OffScreenImageFilter::createDescriptorSet() {
